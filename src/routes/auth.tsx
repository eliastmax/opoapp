...
function AuthPage() {
  ...
  return <div className="min-h-[100svh] flex items-center justify-center px-4 py-[calc(env(safe-area-inset-top,0px)+2rem)] pb-[calc(env(safe-area-inset-bottom,0px)+2rem)]"><div className="w-full max-w-md"><div className="text-center mb-6"><div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary text-primary-foreground mb-3"><GraduationCap className="w-8 h-8" /></div><h1 className="text-2xl font-bold">OpoTest</h1></div><Card className="p-5">
