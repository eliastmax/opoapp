...
function AuthPage() {
  ...
  async function requestRecovery(e: React.FormEvent) { e.preventDefault(); setLoading(true); setMessage(null); const { error } = await supabase.auth.resetPasswordForEmail(email, { redirectTo: `${window.location.origin}/password-recovery` }); setLoading(false); if (error) return fail("request_password_recovery", error); setMessage("Si existe una cuenta con ese email, recibirás un enlace para cambiar la contraseña."); }
