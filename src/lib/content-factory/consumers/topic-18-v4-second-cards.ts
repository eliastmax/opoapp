...
/**
 * Second source-backed card for every non-anchor Topic 18 concept.
 * Card types use only the canonical V4 flashcard taxonomy; evidence dimensions
 * remain a question-generation concern and are not reused as card types.
 */
const seeds: CardSeed[] = [
  ...
  { conceptCode: "SMS-T18-C13", type: "direct", prompt: "¿Qué debe haberse intentado antes de acudir a la ampliación excepcional del artículo 23 cuando existe un volumen elevado de solicitudes o afectados?", answer: "Habilitar los medios personales y materiales necesarios en los términos del artículo 21.5; solo si no bastan puede acordarse motivadamente la ampliación excepcional.", article: "arts. 21.5 y 23", pageStart: 122, pageEnd: 124 },
  ...
  { conceptCode: "SMS-T18-C18", type: "direct", prompt: "¿Quién determina los órganos competentes para expedir copias auténticas?", answer: "Cada Administración Pública determina los órganos que tienen atribuida esa competencia, según el artículo 27.1.", article: "art. 27.1", pageStart: 128, pageEnd: 130 },
  ...
  { conceptCode: "SMS-T18-C20", type: "number_or_deadline", prompt: "¿Desde qué momento se cuenta un plazo expresado por días?", answer: "A partir del día siguiente a la notificación o publicación del acto, o desde el siguiente a aquel en que se produzca la estimación o desestimación por silencio administrativo.", article: "art. 30.3", pageStart: 132, pageEnd: 133 },
  { conceptCode: "SMS-T18-C21", type: "number_or_deadline", prompt: "Si un plazo fijado en meses o años vence en un mes sin día equivalente al de inicio, ¿cuándo expira?", answer: "El último día del mes.", article: "art. 30.4", pageStart: 133, pageEnd: 134 },
  { conceptCode: "SMS-T18-C22", type: "direct", prompt: "A efectos de cumplimiento de plazos por los interesados, ¿cómo trata el registro electrónico la presentación realizada en un día inhábil?", answer: "Se entiende realizada en la primera hora del primer día hábil siguiente, salvo que una norma permita expresamente la recepción en día inhábil.", article: "art. 31.2", pageStart: 134, pageEnd: 135 },
  ...
  { conceptCode: "SMS-T18-C24", type: "direct", prompt: "¿Qué efecto general produce la tramitación de urgencia sobre los plazos?", answer: "Los reduce a la mitad respecto del procedimiento ordinario, salvo los relativos a presentación de solicitudes y recursos.", article: "art. 33.1", pageStart: 136 },
  { conceptCode: "SMS-T18-C25", type: "direct", prompt: "Además de la competencia del órgano, ¿qué exige el artículo 34.1 para la producción del acto?", answer: "Que se ajuste a los requisitos y al procedimiento establecido.", article: "art. 34.1", pageStart: 136 },
  { conceptCode: "SMS-T18-C26", type: "direct", prompt: "¿Qué forma mínima de justificación exige el artículo 35 cuando un acto debe motivarse?", answer: "Una sucinta referencia de hechos y fundamentos de derecho.", article: "art. 35", pageStart: 137, pageEnd: 138 },
  ...
  { conceptCode: "SMS-T18-C28", type: "direct", prompt: "¿Qué resoluciones declara nulas el artículo 37.2?", answer: "Las que vulneren una disposición reglamentaria y las que incurran en alguna de las causas de nulidad de pleno derecho del artículo 47.", article: "art. 37.2", pageStart: 139 },
  ...
  { conceptCode: "SMS-T18-C30", type: "direct", prompt: "¿Cuál es la regla general de eficacia de los actos del artículo 39.1?", answer: "Se presumen válidos y producen efectos desde la fecha en que se dictan, salvo que en ellos se disponga otra cosa.", article: "art. 39.1", pageStart: 139, pageEnd: 140 },
  { conceptCode: "SMS-T18-C31", type: "direct", prompt: "¿Qué sucede con el procedimiento mientras se resuelve el conflicto del artículo 39.5?", answer: "Queda suspendido desde que se formula el requerimiento a la otra Administración para que anule o revise el acto que se considera ilegal.", article: "art. 39.5", pageStart: 140 },
  { conceptCode: "SMS-T18-C32", type: "direct", prompt: "¿Qué información sobre impugnación debe contener una notificación ordinaria?", answer: "Debe indicar si el acto pone fin o no a la vía administrativa, los recursos que procedan, el órgano ante el que interponerlos y el plazo para hacerlo.", article: "art. 40.2", pageStart: 140 },
  ...
  { conceptCode: "SMS-T18-C35", type: "direct", prompt: "¿Cuándo se entiende practicada una notificación electrónica?", answer: "En el momento en que se produce el acceso a su contenido por el interesado o su representante debidamente identificado.", article: "art. 43.2", pageStart: 144 },
  ...
  { conceptCode: "SMS-T18-C38", type: "direct", prompt: "¿Qué debe permitir la indicación somera del artículo 46 a los interesados?", answer: "Comparecer en el lugar y plazo indicados para conocer el contenido íntegro del acto y dejar constancia de ese conocimiento.", article: "art. 46", pageStart: 146 },
  ...
  { conceptCode: "SMS-T18-C41", type: "direct", prompt: "¿Cuándo puede extenderse la invalidez de una parte del acto a las restantes partes independientes?", answer: "Cuando la parte viciada sea de tal importancia que sin ella el acto administrativo no se hubiera dictado.", article: "art. 49.2", pageStart: 148 },
  { conceptCode: "SMS-T18-C42", type: "direct", prompt: "¿Qué efectos produce la conversión del artículo 50?", answer: "El acto nulo o anulable produce los efectos del acto distinto cuyos elementos constitutivos contiene.", article: "art. 50", pageStart: 148 },
  { conceptCode: "SMS-T18-C43", type: "direct", prompt: "¿Qué condición determina la conservación del artículo 51?", answer: "Que el contenido del acto o trámite se hubiera mantenido igual de no haberse cometido la infracción.", article: "art. 51", pageStart: 148 },
  { conceptCode: "SMS-T18-C44", type: "direct", prompt: "¿Desde cuándo produce efectos el acto de convalidación, con carácter general?", answer: "Desde su fecha, salvo lo dispuesto para la retroactividad de los actos administrativos en el artículo 39.3.", article: "art. 52.2", pageStart: 148, pageEnd: 149 },
];
