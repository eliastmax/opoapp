# Implementación de OpoTest Study V2

Este índice registra qué partes de la V2 están realmente implementadas y validadas. Las especificaciones funcionales siguen siendo la fuente conceptual; estos documentos describen el estado efectivo de la aplicación.
...
- [Simplificación de Crear test y bienvenida personalizada](sprint-09-simplificacion-crear.md): implementada y validada en uso real; selector directo y orden numérico global de temas añadidos posteriormente.
